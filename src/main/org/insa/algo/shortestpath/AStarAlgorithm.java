...
public class AStarAlgorithm extends DijkstraAlgorithm{
    ...
    protected ShortestPathSolution doRun() 
    {
		...
		{			
			...
			while (it.hasNext())
			{
				...
				if(distances[noeudy.getId()]==null)
				{
					...
					{
						// si on compare en distance, le cout estim� sera calcul� avec la fonction point.distance
					...
					else if (data.getMode()==Mode.TIME)
					{
						...
						{
							// si oui, on l'utilise pour calculer le cout estim�
		...
		{	
			...
			System.out.println("A* : Nombre de noeuds marqués : "+nbMarked);
	        return solution;
		}
    }
